...
model ms
  ...
  Simulator.Streams.Energy_Stream Reboiler_Duty annotation(
    ...
    //the Simulator.mo and Modelica.mo file should be loaded befor simulating this file
    
    model Mat_stm_Eg
    
      //instantiation of compounds
      parameter Simulator.Files.Chemsep_Database.Methanol meth;
      parameter Simulator.Files.Chemsep_Database.Ethanol eth;
      parameter Simulator.Files.Chemsep_Database.Water wat;
     //instantiation of material shream
      Simulator.Streams.Material_Stream Mat_Stm1(NOC = 3, comp = {meth, eth, wat},P = 202650,T = 373);
    equation
      Mat_Stm1.compMolFrac[1, :] = {0.33, 0.33, 0.34};
      //values in the curley braces is the compound mole fraction in the GUI.  
      //NOTE: the values of each of item in this array should be between 0-1 and their sum should be = 1
      Mat_Stm1.totMolFlo[1] = 100;
      //totMolFlo is Molar Flowrate from the GUI
    end Mat_stm_Eg;
